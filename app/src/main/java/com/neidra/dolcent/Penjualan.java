...
public class Penjualan {
    ...
    public String getId_tipe_bayar() {
        return id_tipe_bayar;
    }

    public void setId_tipe_bayar(String id_tipe_bayar) {
        this.id_tipe_bayar = id_tipe_bayar;
    }
